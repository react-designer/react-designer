    ...
    return (
      <Designer width={500} height={500}
        ...
        objects={this.state.objects} />
          ...
          You should listen onUpdate callback to update your objects.
          React-designer will invoke this callback in every update.
        </div>
        <h4 id="examples" className={classes.mainTitle}>
          Examples
        </h4>
        ...
        <div className={classes.example}>
          <div className={classes.info}>
            <h3>Malevich</h3>
            <p>
              Default configuration with initial shapes (bezier curves) set on
              the internal state of container component.
            </p>

            <p>You can double-click to edit shapes.</p>
            <p>
              <a href="https://github.com/fatiherikli/react-designer/blob/master/examples/components/Malevich.js">
                Show example on github
              </a>
            </p>
          </div>
        ...
        <div className={classes.example}>
          <div className={classes.info}>
            ...
            <p>
              Default configuration with initial text and shapes with blending
              modes on the internal state of container component.
            </p>

            <p>
              <a href="https://github.com/fatiherikli/react-designer/blob/master/examples/components/SwissStyle.js">
                Show example on github
              </a>
            </p>
          </div>
        ...
        <div className={classes.example}>
          <div className={classes.info}>
            ...
            <ul>
              <li>
                <a href="https://github.com/fatiherikli/react-designer/blob/master/examples/components/MockupDesigner.js#L32">
                  Button
                </a>
              </li>
              <li>
                <a href="https://github.com/fatiherikli/react-designer/blob/master/examples/components/MockupDesigner.js#L73">
                  Input
                </a>
              </li>
              <li>
                <a href="https://github.com/fatiherikli/react-designer/blob/master/examples/components/MockupDesigner.js#L7">
                  H1
                </a>
              </li>
              <li>
                <a href="https://github.com/fatiherikli/react-designer/blob/master/examples/components/MockupDesigner.js#L19">
                  Link
                </a>
              </li>
              <li>
                <a href="https://github.com/fatiherikli/react-designer/blob/master/examples/components/MockupDesigner.js#L113">
                  Fieldset
                </a>
              </li>
            </ul>
            ...
            <p>
              These components are derived from Vector, but they are still pure
              React components.
            </p>

            <p>
              <a href="https://github.com/fatiherikli/react-designer/blob/master/examples/components/MockupDesigner.js">
                Show example on github
              </a>
            </p>
          </div>
        ...
        <div className={classes.example}>
          <div className={classes.info}>
            ...
            <p>
              Default toolset with customized designer canvas for building
              simple tshirt design tool.
            </p>

            <p>
              Price calculation is a simple pure function that receives object
              list and returns total price.
            </p>

            <p>
              In this demo, price is relative to covered areas of objects on the
              canvas. For example price is instantly changing while you resizing
              objects or typing a text.
            </p>

            <p>
              <a href="https://github.com/fatiherikli/react-designer/blob/master/examples/components/TshirtDesigner.js">
                Show example on github
              </a>{' '}
              <br />
            </p>
